  ...
  const sidebarContent = (
    <aside className="w-64 h-full flex flex-col" style={{ background: 'hsl(var(--sidebar-background))' }}>
      ...
      <div className="relative px-5 pt-6 pb-5 flex items-center justify-between flex-shrink-0"
        ...
        <div className="absolute top-0 left-0 w-32 h-16 rounded-full opacity-20 pointer-events-none"
      ...
      <div className="px-3 py-4 flex-shrink-0 space-y-2"
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg"
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold truncate" style={{ color: 'hsl(var(--sidebar-accent-foreground))' }}>
              {user.name}
            </p>
            <p className="text-[11px] capitalize" style={{ color: 'hsl(var(--sidebar-foreground))' }}>
              {user.role}
            </p>
          </div>
        </div>
